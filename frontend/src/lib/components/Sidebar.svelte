      ...
      <nav class="sidebar-nav">
        {#each projects as proj}
          ...
          <div class="sidebar-project">
            <button class="sidebar-link sidebar-project-header" class:active={selectedSession && projSessions.some(s => s.ID === selectedSession.ID)} onclick={() => { const s = projSessions[0]; if (s) onselectsession?.(s); }}>
